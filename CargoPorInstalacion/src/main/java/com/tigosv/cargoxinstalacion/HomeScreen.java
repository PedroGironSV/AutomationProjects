...
import matrices.EscenariosAdicionalesAPI;
import matrices.EscenariosAllAPI;
import matrices.EscenariosValoresAPI;
...
public class HomeScreen extends javax.swing.JFrame {
    ...
    EscenariosAllAPI all = new EscenariosAllAPI();
    EscenariosValoresAPI val = new EscenariosValoresAPI();
    EscenariosAdicionalesAPI adi = new EscenariosAdicionalesAPI();
    public String message, matrixName;
    public static String title, nameQA, tkt_RFC, environment, filePath;
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Pruebas de cargo por instalación");
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
        if (isSetEnvironment()) {
            ...
            adi.filePath = filePath;
            val.runEscenariosValores(); //Ejecutar casos matriz Escenarios Valores API
            all.runEscenariosAll(); //Ejecutar casos matriz Escenarios All API
            adi.runEscenariosAdicionales(); //Ejecutar casos matriz Escenarios Adicionales API
            JOptionPane.showConfirmDialog(null, "Set de pruebas finalizado.\n"
                    + "Encontrará las evidencias en el Escritorio o en el Issue Log, según corresponda.", "EJECUCION FINALIZADA", JOptionPane.DEFAULT_OPTION, JOptionPane.DEFAULT_OPTION, information);
        }
